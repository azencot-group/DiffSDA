...
from facexzoo.core.model_loader.BaseModelLoader import BaseModelLoader
...
class FaceDetModelLoader(BaseModelLoader):
    ...
    def load_model(self):
        try:
            import facexzoo.models.network_def
            import sys
            sys.modules['models.network_def'] = facexzoo.models.network_def
